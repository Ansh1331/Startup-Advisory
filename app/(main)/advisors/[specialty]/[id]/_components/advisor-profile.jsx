...
export function AdvisorProfile({ advisor, availableDays }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {/* Left column - Advisor Photo and Quick Info (fixed on scroll) */}
      <div className="md:col-span-1">
        <div className="md:sticky md:top-24">
          <Card className="border-cyan-900/20">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                <div className="relative w-32 h-32 rounded-full overflow-hidden mb-4 bg-cyan-900/20">
                  {advisor.imageUrl ? (
                    <Image
                ...
                <Badge
                  variant="outline"
                  className="bg-cyan-900/20 border-cyan-900/30 text-cyan-300 mb-4"
                >
                  {advisor.specialty}
                </Badge>

                <div className="flex items-center justify-center mb-2">
                  <Medal className="h-4 w-4 text-cyan-300 mr-2" />
      ...
      {/* Right column - Advisor Details and Booking Section */}
              ...
              <CardContent className="space-y-6">
                {totalSlots > 0 ? (
                  ...
                  <div className="text-center py-6">
                    ...
                    <p className="text-muted-foreground">
                      This advisor doesn&apos;t have any available appointment
